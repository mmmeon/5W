...
- [~] #18 doctor: name a trunk checkout holding an exact copy of a branch's diff @doctor !1 branch:doctor/task-18 submitted:e510739dc821
...
- [ ] #24 row(): append a size hint when a title is truncated, not a bare ellipsis @output !1 needs:#13 branch:output/task-24 rework:"row hint hard-codes 5w: build it from cfg.cmd_tasks like the other hints, and test with a custom commands.tasks"
