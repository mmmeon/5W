...
- [~] #41 wt prune: keep any <area>/task-<id> branch of an open task, not only the currently suggested name @wt !1 branch:wt/task-41 submitted:0d13d58f3b0a
...
- [~] #42 FIVEW_WT_ROOT set but empty puts worktrees inside the primary checkout: treat empty as unset @wt !1 branch:wt/task-42 submitted:07cfc9286a90
