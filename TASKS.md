...
- [~] #19 Batch accept (accept 4 5 6) and ship --accepted: land every accepted branch bottom of stack first @queue !2 branch:queue/task-19 submitted:59a18bf7600c
...
- [~] #45 lint: refuse single-dash tokens and extra arguments instead of a raw rev-parse error or silently ignoring them @output !1 branch:output/task-45 submitted:40564aa78d6d
