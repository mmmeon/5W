...
- [~] #37 FIVEW_WT_ROOT relative: resolved against the cwd when checked but against the primary checkout by git worktree add @wt !1 branch:wt/task-37 submitted:522b7ef9f714
...
- [~] #39 USAGE hook line omits [pre-commit | pre-receive], so hook --help under-describes it @output !1 branch:output/task-39 submitted:75af304a7fa0
