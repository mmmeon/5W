...
- [~] #17 wt prune: remove worktrees and branches with no commits past their parent, no changes, and no task naming them @wt !2 rework:"prune --yes deletes a worker's just-created worktree: keep every non-closed task's suggested branch and worktrees outside worktrees.root; skip branches mid-rebase/bisect; re-check tip and ignored files right before removing" branch:wt/task-17 submitted:e828a5bdc848
