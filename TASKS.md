...
- [~] #34 USAGE: one example invocation under the usage line, e.g. 5w ready area:output @output !1 needs:#13 rework:"example uses this repo's own area (area:output lists nothing elsewhere): use 5w ready level:1, which works in every queue" branch:output/task-34 submitted:13f4d86feea5
