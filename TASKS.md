...
- [ ] #56 Check: a working copy still holding a row the trunk has archived — does naming it copy the row back and duplicate it? @queue !1
...
- [~] #57 store::write drops a staged-copy fix when the committed text is unchanged @queue !2 branch:queue/task-57 submitted:658f2073399c
